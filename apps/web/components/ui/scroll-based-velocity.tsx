...
export function VelocityScroll({
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 h-full w-1/3 bg-linear-to-r from-white to-transparent" />
      <div className="absolute top-0 right-0 h-full w-1/3 bg-linear-to-l from-white to-transparent" />
    </div>
  );
}
