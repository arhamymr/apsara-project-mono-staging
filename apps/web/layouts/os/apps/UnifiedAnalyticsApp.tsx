...
const DATASETS = {
  ...
  year: [
    ...
    'Nov',
    'Dec',
  ].map((d, i) => ({ ...makeSeries(12)[i], label: d })),
} as const;
      ...
      <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-muted-foreground text-sm">
            Comprehensive analytics with traffic, conversions, and performance
            metrics
          </p>
        </div>
              ...
              <div className="mt-4 space-y-2">
                {DEVICE_DATA.map((device, index) => (
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <div
                        className={`h-3 w-3 rounded-full ${device.color}`}
                      ></div>
      ...
      {activeTab === 'traffic' && (
        <>
          ...
          <div className="mb-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            />
            <StatCard
              title="Avg per Interval"
              value={kpi.avg.toLocaleString()}
              hint={period}
              trend={3}
      ...
      {activeTab === 'conversions' && (
        <>
          ...
          <div className="grid gap-4 lg:grid-cols-3">
            <div className="lg:col-span-2">
              <TrafficChart
                series={series.map((s) => ({ ...s, visits: s.conversions }))}
              />
            </div>
            <div className="rounded-lg border p-4">
