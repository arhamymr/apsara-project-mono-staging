...
export const CTA_STRINGS: Record<Lang, any> = {
  en: {
    title: 'Ready to Build Your Digital Presence?',
    desc: 'Let us help you create a professional website, integrate AI solutions, or build custom applications that drive real business results.',
  ...
  id: {
    ...
    note: 'Konsultasi gratis tersedia. Tanpa komitmen.',
  },
};
