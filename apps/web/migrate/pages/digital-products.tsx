...
export default function DigitalProducts() {
  return (
    <>
      <Head title="Digital Products - Templates, UI Kits & Design Assets | Apsara Digital" />
...
function ProductShowcase() {
  ...
  const allProducts: ProductItem[] = [
    ...s.webDesign.items.map((item) => ({ ...item, type: 'web-design' })),
    ...s.illustrations.items.map((item) => ({
      ...item,
      type: 'illustrations',
    })),
  ];
