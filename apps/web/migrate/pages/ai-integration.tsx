...
function useStrings() {
  ...
  return AI_INTEGRATION_STRINGS[lang];
}

export default function AiIntegration() {
  return (
    <>
      <Head title="AI Integration Services - Smart Automation Solutions | Apsara Digital" />
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          >
            ...
            <Button size="lg" variant="outline" asChild>
              <a href="#services">View Solutions</a>
            </Button>
          </motion.div>
        </div>
      </div>
...
function TrustBadges() {
  ...
  const badges = [
    ...
    { icon: Sparkles, label: 'Latest AI Models' },
  ];
...
function ServicesSection() {
  ...
  const services = [
    { icon: Cpu, ...s.services.list[0] },
    { icon: Database, ...s.services.list[1] },
    { icon: Bot, ...s.services.list[2] },
    { icon: Workflow, ...s.services.list[3] },
    { icon: Mic, ...s.services.list[4] },
    { icon: Sparkles, ...s.services.list[5] },
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className="relative z-10">
            <Brain className="text-primary-foreground/80 mx-auto mb-8 h-12 w-12" />
