...
export function AILoadingBar() {
  ...
  if (toolName === 'comment' && status === 'ready') {
    return (
      <div
        className={cn(
          'border-border bg-popover text-muted-foreground absolute bottom-4 left-1/2 z-50 flex -translate-x-1/2 flex-col items-center gap-0 rounded-xl border p-1 text-sm shadow-xl backdrop-blur-sm',
          'p-3',
        )}
      >
