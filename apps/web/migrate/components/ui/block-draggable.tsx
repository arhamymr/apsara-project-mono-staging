...
function Draggable(props: PlateElementProps) {
  ...
  try {
    ...
    // If DnD context is not available, render without drag functionality
...
const DropLine = React.memo(function DropLine({
  ...
  try {
    ...
    dropLine = dropLineState.dropLine;
  } catch (error) {
    // If DnD context is not available, don't render drop line
    return null;
  }
